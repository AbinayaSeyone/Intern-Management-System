...
public class CompanyQuery implements EntityQuery{
    ...
    @Filter(path = "email")
    private List<StringParameter>email = emptyList();
    @Filter(path = "linkedInLink")
    private List<StringParameter>linkedInLink = emptyList();
    ...
    public List<StringParameter> getEmail() {
        return email;
    }


    public void setEmail(List<StringParameter> email) {
        this.email = email;
    }
    public List<StringParameter> getLinkedInLink() {
        return linkedInLink;
    }


    public void setLinkedInLink(List<StringParameter> linkedInLink) {
