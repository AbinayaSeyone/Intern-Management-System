...
@GraphQLType
public class InternPoolOpeningQuery implements EntityQuery {
    @Filter(path = "id")
    ...
    @Filter(path = "interns", index = IndexType.object)
    private List<DocParameter> interns = emptyList();
    ...
    public List<DocParameter> getInterns() {
        return interns;
    }

    public void setInterns(List<DocParameter> interns) {
